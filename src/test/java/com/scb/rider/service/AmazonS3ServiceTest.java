...
class AmazonS3ServiceTest {
    ...
    private static final String FOLDER_NAME = "Selfie";
    private static final String KEY = "11234/20-Feb-2011";
    private static final String TEMP_FILE_NAME = "temp.txt";

    @InjectMocks
    private AmazonS3ImageService amazonS3Service;
    ...
    @Test
    void shouldUploadFile() throws IOException, FileConversionException {
        File file = null;
        try {
